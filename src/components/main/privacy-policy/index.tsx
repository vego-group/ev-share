  ...
  return (
    <section className="mx-auto w-full max-w-245 px-4 py-12 md:py-16">
      ...
      <div className="mt-8 space-y-6 text-secondary">
        ...
        <section>
          <h2 className="text-xl font-bold md:text-2xl">{t("sharingTitle")}</h2>
          <p className="mt-2 leading-8 whitespace-pre-line">
            {t("sharingBody")}
          </p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold md:text-2xl">{t("rightsTitle")}</h2>
          <p className="mt-2 leading-8 whitespace-pre-line">
            {t("rightsBody")}
          </p>
        </section>
        ...
        <section>
          <h2 className="text-xl font-bold md:text-2xl">{t("contactTitle")}</h2>
