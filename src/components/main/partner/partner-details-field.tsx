...
import { fieldErrorClassName } from "./partner-field-styles";
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        className={`block w-full rounded-2xl border bg-white px-4 py-4 text-start text-base text-secondary outline-none transition duration-200 placeholder:text-start placeholder:text-secondary/45 ${
          errorMessage
            ? fieldErrorClassName
