  ...
  return (
    <section className="relative isolate min-h-135 overflow-hidden border-t border-primary bg-[#0b0d12] py-12 md:min-h-162.5 md:py-16">
      ...
      <motion.div
        ...
        animate={{ x: [0, 18, 0], y: [0, 12, 0], rotate: [0, 2.2, 0] }}
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6">
        <h2 className="text-center text-[36px] font-medium text-[#f2f2f2] md:text-[52px]">
          {t("title")}
        </h2>
